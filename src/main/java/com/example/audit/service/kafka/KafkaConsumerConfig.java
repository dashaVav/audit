...
public class KafkaConsumerConfig {
    ...
    private Map<String, Object> consumerConfig() {
        ...
        properties.put(JsonDeserializer.VALUE_DEFAULT_TYPE, AuditAction.class);
        return properties;
    }

    private ConsumerFactory<String, AuditAction> consumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfig(),
                new StringDeserializer(),
                new JsonDeserializer<>(AuditAction.class, false)
        );
    }

    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, AuditAction>> factory() {
